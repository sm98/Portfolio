...
$(document).ready(function () {  
	...
	projLinks.forEach(link=>{
	 ...
	 $(window).scroll(function () {
		...
		if(bottom3rdOfWindow>card6){$("#bg").css("background-color", "#f9efeb");$("#header").css("background-color", "#f9efeb"); }
		else{
			if(bottom3rdOfWindow>card5){$("#bg").css("background-color", "#f3ebf9");$("#header").css("background-color", "#f3ebf9"); }
			else{
				if(bottom3rdOfWindow>card4){$("#bg").css("background-color", "#d5e8f2");$("#header").css("background-color", "#d5e8f2"); }
				else{
					if(bottom3rdOfWindow>card3){$("#bg").css("background-color", "#f9ebeb");$("#header").css("background-color", "#f9ebeb"); }
					else{
